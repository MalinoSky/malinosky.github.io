...
function arr(elem){
	...
	if(document.getElementById("pic"+num).className.indexOf("down")>-1)
		{document.getElementById("pic"+num).className=document.getElementById("pic"+num).className.replace(new RegExp(" down\\b"), "");}
	else{ document.getElementById("pic"+num).className+=" down";}
}
